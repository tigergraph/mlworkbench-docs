...
. visit our website at https://www.tigergraph.com/ml-workbench/ and sign up to download ML Workbench
. Once the sign up process is complete, you will be receiving an email with instructions to download and setup ML Workbench
. Run the docker command that is listed in the email to pull the Workbench image, bind ports, map a shared data folder, and start a container from the image
