...
It is available as a service through TigerGraph Cloud (xref:on-cloud:on-tgcloud.adoc[accessible through a Cloud Starter Kit]) or standalone in two editions, Developer and Enterprise.
