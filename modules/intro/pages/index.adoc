...
TigerGraph Machine Learning (ML) Workbench is an end-to-end graph machine learning platform orchestrated by KubeFlow.
...
See xref:getting-started:activate.adoc[the UDF page] to learn how to deploy these UDFs to your database before using pyTigerGraph.
